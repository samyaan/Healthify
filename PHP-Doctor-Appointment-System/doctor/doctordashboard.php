        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="colorlib-regform-5/index.php"><i class="fa fa-fw fa-edit"></i> Patient E-card Registration</a>
                    </li>
                        ...
                        <table class="table table-hover table-bordered">
                            <thead>
                                <tr class="filters">
                                    ...
                                    <th><input type="text" class="form-control" placeholder="Meet Link" disabled></th>
                            ...
                            while ($appointment = mysqli_fetch_array($res)) {
                                ...
                                echo "<td><a href='https://meet.google.com/' id='btn'>Click Here to Start Meeting</td>";
