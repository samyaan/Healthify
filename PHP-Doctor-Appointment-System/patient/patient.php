			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<ul class="nav navbar-nav">
						...
						<li><a href="emed\log.php">Emed</a></li>
						<li><a href="emerg.php">SOS</a></li>
						<li><a href='ecard.php?appid=".$userRow[' appId']."' target='_blank'>E-Card</a>
						</li>
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						<div class="mySlides fade">
							...
							<img src="images/Doc1.png" style="width:100%">
							<div class="text">Caption Text</div>
						</div>

						<div class="mySlides fade">
							<div class="numbertext">2 / 3</div>
							<img src="images/Doc2.png" style="width:100%">
							<div class="text">Caption Two</div>
						</div>

						<div class="mySlides fade">
							<div class="numbertext">3 / 3</div>
							<img src="images/Doc3.png" style="width:100%">
	...
	<div class="wrapper row2">
		<section id="latest" class="hoc container clear">
			...
			<ul class="nospace group">
				...
				<li class="one_third">
					<figure><a class="imgover" href="emed/covid.php"><img src="images/skin.jpg" alt=""></a>
