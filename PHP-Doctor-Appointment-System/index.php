...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="adminlogin.php">Hospital's Login</a></li>
    ...
    <!-- ################################################################################################ -->
    <!-- ################################################################################################ -->
    <div class="wrapper bgded overlay gradient" style="background-image:url('patient/images/f1.jpeg');">
        <div id="pageintro" class="hoc clear">
            <!-- ################################################################################################ -->
            <article>
                <p>Book apointments online</p>
                <h3 class="heading">Find nearby Hospitals</h3>
                <p>Experience taught me that working families are often just one pay check away from economic disaster. And it
                    showed me first-hand the importance of every family having access to good health care.</p>
                <footer>
    ...
    <div class="wrapper row2">
        <section id="latest" class="hoc container clear">
            ...
            <ul class="nospace group">
                ...
                <li class="one_third">
                    <figure><a class="imgover" href="#"><img src="patient/images/skin.jpg" alt=""></a>
